...
class OrderView(View):
    ...
    def patch(self, request, order_item_id):
        ...
        with transaction.atomic():
            ...
            order_items.update(
                shipping_status = ShippingStatus.objects.get(id=ShipptingStatusEnum.RETURN_REQUEST)
                )
            
            order_item.order.order_status_id = OrderStatus.objects.get(id=OrderStatusEnum.PARTIAL_CANCELLATION)
